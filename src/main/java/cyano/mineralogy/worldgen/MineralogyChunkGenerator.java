...
public class MineralogyChunkGenerator extends ChunkProviderGenerateCustom {
     ...
     * Abstract3FCoordinateNoiseGenerator perlinNoise = new Default3FCoordinateNoiseGenerator(new
     * Default3CoordinatePRNG(world.getSeed(),-1f,1f),Mineralogy.ROCK_LAYER_SIZE);
     ...
     * world.setBlock(x,y,z,pickBlockFromList(perlinNoise.getValue(x, y*Mineralogy.Y_SCALE_FACTOR,
     * z),Mineralogy.igneousStones));
     * }
     * }
     * }
     * }
