...
public class MineralogyConfig {
    ...
    public static void preInit(FMLPreInitializationEvent event) {
        ...
        placeMineralogyRock = config.getBoolean(
            "PLACE_MINERALOGY_ROCK",
            OPTIONS,
            placeMineralogyRock,
            "If true, then generic stone is replace for mineralogy rocks");

        patchUpdate = config.getBoolean(
            "patch_world",
            OPTIONS,
            patchUpdate,
        ...
        rockLayerNoise = (double) config.getFloat(
            "ROCK_LAYER_NOISE",
            WORLD_GEN,
            (float) rockLayerNoise,
            1.0f,
            (float) Short.MAX_VALUE,
            "Changing this value will change the 'waviness' of the layers.");
        geomLayerThickness = config.getInt(
            "ROCK_LAYER_THICKNESS",
            WORLD_GEN,
            geomLayerThickness,
            1,
            255,
        ...
        generateReliefs = config
            .getBoolean("GENERATE_RELIEFS", OPTIONS, generateReliefs, "If true, then rock reliefs will be generated");
        generateRockStairs = config.getBoolean(
            "GENERATE_ROCKSTAIRS",
            OPTIONS,
            generateRockStairs,
            "If true, then rock stairs will be generated");
        generateRockFurnace = config.getBoolean(
            "GENERATE_ROCKFURNACE",
            OPTIONS,
            generateRockFurnace,
            "If true, then rock furnaces will be generated");
        generateRockSlab = config
            .getBoolean("GENERATE_ROCKSLAB", OPTIONS, generateRockSlab, "If true, then rock slabs will be generated");
        generateRockWall = config
            .getBoolean("GENERATE_ROCKWALL", OPTIONS, generateRockWall, "If true, then rock walls will be generated");
        generateBrick = config
            .getBoolean("GENERATE_BRICK", OPTIONS, generateBrick, "If true, then rock brick blocks will be generated");
        generateBrickFurnace = config.getBoolean(
            "GENERATE_BRICKFURNACE",
            OPTIONS,
            generateBrickFurnace,
            "If true, then brick furnaces will be generated");
        generateBrickStairs = config.getBoolean(
            "GENERATE_BRICKSTAIRS",
            OPTIONS,
            generateBrickStairs,
            "If true, then brick stairs will be generated");
        generateBrickSlab = config.getBoolean(
            "GENERATE_BRICKSLAB",
            OPTIONS,
            generateBrickSlab,
            "If true, then brick slabs will be generated");
        generateBrickWall = config.getBoolean(
            "GENERATE_BRICKWALL",
            OPTIONS,
            generateBrickWall,
            "If true, then brick walls will be generated");
        generateSmooth = config
            .getBoolean("GENERATE_SMOOTH", OPTIONS, generateSmooth, "If true, then polished rock will be generated");
        generateSmoothFurnace = config.getBoolean(
            "GENERATE_SMOOTHFURNACE",
            OPTIONS,
            generateSmoothFurnace,
            "If true, then smooth furnaces will be generated");
        generateSmoothStairs = config.getBoolean(
            "GENERATE_SMOOTHSTAIRS",
            OPTIONS,
            generateSmoothStairs,
            "If true, then polished rock stairs will be generated");
        generateSmoothSlab = config.getBoolean(
            "GENERATE_SMOOTHSLAB",
            OPTIONS,
            generateSmoothSlab,
            "If true, then polished rock slabs will be generated");
        generateSmoothWall = config.getBoolean(
            "GENERATE_SMOOTHWALL",
            OPTIONS,
            generateSmoothWall,
            "If true, then polished walls will be generated");
        generateSmoothBrick = config.getBoolean(
            "GENERATE_SMOOTHBRICK",
            OPTIONS,
            generateSmoothBrick,
            "If true, then polished brick blocks will be generated");
        generateSmoothBrickFurnace = config.getBoolean(
            "GENERATE_SMOOTHBRICKFURNACE",
            OPTIONS,
            generateSmoothBrickFurnace,
            "If true, then smooth brick furnaces will be generated");
        generateSmoothBrickStairs = config.getBoolean(
            "GENERATE_SMOOTHBRICKSTAIRS",
            OPTIONS,
            generateSmoothBrickStairs,
            "If true, then polished brick stairs will be generated");
        generateSmoothBrickSlab = config.getBoolean(
            "GENERATE_SMOOTHBRICKSLAB",
            OPTIONS,
            generateSmoothBrickSlab,
            "If true, then polished brick slabs will be generated");
        generateSmoothBrickWall = config.getBoolean(
            "GENERATE_SMOOTHBRICKWALL",
            OPTIONS,
            generateSmoothBrickWall,
            "If true, then polished brick walls will be generated");

        groupCreativeTabItemsByType = config.getBoolean(
            "GROUP_TABS_BY_TYPE",
            OPTIONS,
            groupCreativeTabItemsByType,
        ...
        igneousBlacklist.addAll(
            asList(
                ...
                ";"));
        sedimentaryBlacklist.addAll(
            asList(
                config.getString(
                    "sedimentary_blacklist",
                    WORLD_GEN,
                    "",
                    "Ban blocks from spawning in rock layers " + FORMAT_LIST_MESSAGE),
                ";"));
        metamorphicBlacklist.addAll(
            asList(
                config.getString(
                    "metamorphic_blacklist",
                    WORLD_GEN,
                    "",
                    "Ban blocks from spawning in rock layers " + FORMAT_LIST_MESSAGE),
                ";"));

        igneousWhitelist.addAll(
            asList(
                config
                    .getString("igneous_whitelist", WORLD_GEN, "", "Adds blocks to rock layers " + FORMAT_LIST_MESSAGE),
                ";"));
        sedimentaryWhitelist.addAll(
            asList(
                config.getString(
                ...
                ";"));
        metamorphicWhitelist.addAll(
            asList(
                config.getString(
                    "metamorphic_whitelist",
                    WORLD_GEN,
                    "",
                    "Adds blocks to rock layers " + FORMAT_LIST_MESSAGE),
                ";"));
