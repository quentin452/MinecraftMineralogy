...
public class MinIoC {
    ...
    public <K, V extends K> boolean register(Class<K> key, V value, ResourceLocation resourceLocation) {
        return _instance.container.put(new HashTuple2<Class<?>, String>(key, resourceLocation.toString()), value)
            == null;
    }
    ...
    public <K, V extends K> boolean register(Class<K> key, V value, MMDResourceLocation resourceLocation) {
        return _instance.container.put(new HashTuple2<Class<?>, String>(key, resourceLocation.getResourcePath()), value)
            == null;
    ...
    public <K, V extends K> boolean register(Class<K> key, V value, String instanceName, String modID) {
        return _instance.container.put(new HashTuple2<Class<?>, String>(key, modID + ":" + instanceName), value)
            == null;
    }
