...
public class Constants {
    ...
    public static final String[] colorSuffixes = { "black", "red", "green", "brown", "blue", "purple", "cyan", "silver",
        "gray", "pink", "lime", "yellow", "light_blue", "magenta", "orange", "white" };
    public static final String[] colorSuffixesTwo = { "Black", "Red", "Green", "Brown", "Blue", "Purple", "Cyan",
